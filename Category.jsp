<%-- 
    Document   : Cate
    Created on : Sep 12, 2015, Sep 12, 2015 2:52:15 PM
    Author     : Ramin
--%>
...
<html>
    ...
    <body>
        ...
        <%
            double val = db.listProducts().size();
            int fullPageCount = (int) Math.ceil(val / 3);
            int pageCount = 0;
            int currentPage = 1;
                            ...
                            <div class="block_content">
                                ...
                                <div class="layered layered-filter-price">
                                    ...
                                    <div class="layered-content slider-range">
                                        <input id="priceBar" type="range" min="1" max="150" step="1" />
                        ...
                        <div id="view-product-list" class="view-product-list">
                            ...
                            <div id="priceList">
                                ...
                                <ul class="row product-list grid">
                                    <% for (Product p : db.listProducts(pageCount)) {%>
